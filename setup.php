...
<div id="DialogDiv2" style='height: 305px;'>
	...
	<div id="DContDiv">
		...
		<tr>
			<td style="font-size:14px;text-shadow: 2px 2px 5px #444; color: #337;"><input type="radio" name="PassType" value="1" checked id="MD5Pass" onclick="ChangeSQLPath(0);"> <b> MD5 </b></td>
			<td style="font-size:14px;text-shadow: 2px 2px 5px #444;color: #337;"><span style="text-align:center;"><input type="radio" name="PassType" value="2" id="Base64Pass" onclick="ChangeSQLPath(1);"> <b>Base64</b></span>
			<span style="float:right;"><input type="radio" name="PassType" value="3" id="BinPass" onclick="ChangeSQLPath(2);"> <b>VarBin</b></span>
		</td></tr>
