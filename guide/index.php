...
include "../config.php";
	...
	echo"
	<div id='ClassButtons'>
	<div class='flex flex-wrap justify-center w-full' style='border:0px solid #000;'>";
	$i = 1; 
		while($i <= count($PWclass)) {
		echo "<a href='javascript:void(0);' class='myButtonGrey' onclick=\"showClassTab('".$i."');\">".$PWclass[$i]."</a>";
		$i++;
	} 
	echo"</div></div>";
	...
	*Warriors can use every weapon with the exception of Crossbows, Slingshots. <br><br>
	...
	echo"
	<div id='MainTab1' style='display:none; padding: 32px;text-align:left;'>
	<img src='../images/class/Class_Guide.jpg' style='width:100%;max-width: 800px' alt='Guide'>
	<br><br>
	...
	<font size='2' color='#7777ff'><b>Pro:</b> most flexible class with most weapon type useage, good area damage skills and can stun lock, high defense.</font><br>
	<font size='2' color='#ff7777'><b>Contra:</b> short range class, need alot vigor for combos.</font>
	<br><br>
	...
	<font size='2' color='#7777ff'><b>Pro:</b> highest damage per hit class, good debuff and aoe skills.</font><br>
	<font size='2' color='#ff7777'><b>Contra:</b> slow casting, lack of physical attack skills, need keep distance.</font>
	<br><br>
	...
	<font size='2' color='#7777ff'><b>Pro:</b> good tank class, good physical defence and movement speed in tiger form.</font><br>
	<font size='2' color='#ff7777'><b>Contra:</b> short range, low magical defense, higher repair cost.</font>
	<br><br>
	...
	<font size='2' color='#7777ff'><b>Pro:</b> debuff, purge and tricky skills, can use pets, spammable skills.</font><br>
	<font size='2' color='#ff7777'><b>Contra:</b> low damage per hit, harder to mastery.</font>
	<br><br>
	...
	<font size='2' color='#7777ff'><b>Pro:</b> spamable phyisical and metal element skills, good heal, buff skills, decent debuffs.</font><br>
	<font size='2' color='#ff7777'><b>Contra:</b> mana hungry class, often primary target in pvp.</font>
	<br><br>
	...
	<font size='2' color='#7777ff'><b>Pro:</b> highest range, critical strike rate in game, good dodge and accurancy, can use metal damage skills.</font><br>
	<font size='2' color='#ff7777'><b>Contra:</b> low dph skills, depend on luck.</font>
	</div>";
	
	echo"
		<div id='MainTab3' style='display:none;padding: 32px;text-align:left;'>
	...
	<div id='MainTab5'>
		<div style='width:100%;border:0px solid #000;font-weight:bold;text-align:center;'>
			...
			<br><br><br><br><br>
			<div class='flex gap-8 justify-center text-center flex-wrap'>
				<div>
