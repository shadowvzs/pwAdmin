...
<td><a href="javascript:void(0);" class="myButton" onClick="location.href='../my-account';">Account Info</a></td>
<td><a href='javascript:void(0);' class='myButton' onClick="location.href='../guilds'">Guild Info</a></td>
<td><a href='javascript:void(0);' class='myButton' onClick="location.href='../roles'">Role Info</a></td>
<?php 
if ($admin){
?>
	<td><a href='javascript:void(0);' class='myButton' onClick="location.href='../server'">Server tool</a></td>
	<td><a href='javascript:void(0);' class='myButton' onClick="location.href='../item-builder';">Item Builder</a></td>
<!-- './cpanel/roledata.php' -->
<?php
}
if ($WebShop !== false){
	echo"<td><a href='javascript:void(0);' class='myButton' onClick='location.href=\"../webshop\";'>Web Shop</a></td>";
}
?>
