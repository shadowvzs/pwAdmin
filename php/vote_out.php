...
$vId = intval($_GET['voteid']);
if (($vId > 0) &&(isset($_SESSION['un'])) && (isset($_SESSION['id']))) {
...
if (isset($header_arr["success"]) && (strlen($header_arr["success"]) > 0)) {
	$newURL = "http://retroms.ddns.net/pwAdmin/page/myacc.php";
